...
\n\n---\n\n# Production SQL Review Lock — Migration 034 → 040 — 2026-09-21\n\nCác điểm design cũ về Agent global đã được thay bằng contract V2.1 hiện hành:\n\n- 031 Agent là tenant-scoped với organization_id bắt buộc và UNIQUE(organization_id, name).\n- 034 Tool Capability là mapping của Tool, PK (tool_id, capability), ON DELETE CASCADE.\n- 035 Agent Run mang organization_id và DB enforce user membership + Agent cùng organization.\n- 036 Tool Run thuộc Agent Run; account chỉ là optional provider account FK và không lưu credential.\n- 037 Agent Task mang organization_id; parent task, creator/assignee agent và target resource phải cùng organization bằng composite FK.\n- 038 Agent Permission mang organization_id; grantor/grantee/resource phải cùng organization.\n- 039 Agent Message mang organization_id; sender/receiver/task phải cùng organization.\n- 040 Automation root mang organization_id; owner phải là member của organization; name unique trong organization.\n- Migration 041/042 tiếp tục kế thừa tenant scope từ Automation.\n\nProduction SQL 034 → 040 đã được tạo theo lock này; acceptance verification vẫn là gate bắt buộc trước khi CLOSED.\n