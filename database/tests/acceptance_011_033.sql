...
BEGIN
 ...
 INSERT INTO resources (organization_id,owner_user_id,name,resource_type,provider,external_id,user_account_id) VALUES (org_a,user_a,'AT Resource A','document','google','at011033-resource-a',account_a) RETURNING id INTO resource_a;
